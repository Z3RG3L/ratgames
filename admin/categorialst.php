              ...
              <div class="card">
                ...
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped">
                      ...
                      if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                          ...
                          <tr $colorInactivo>
                            ...
                            <td>" . $row["activo"] . "</td>
                            <td>" . $row["prefijo"] . "</td>
                            <td><a href='categoria.php?cvecat=" . md5($row["cve_cat"]) . "'><i class=\"far fa-edit\"></i></a></td>
                            <td><a href='categoriaAcciones.php?acc=elimina&cvecat=" .  md5($row["cve_cat"])  . "'><i class=\"fa fa-trash-alt\"></i></a></td>
                    ...
                    <tfoot>
                      <tr>
                        <th>Clave de la categoría</th>
                        <th>Nombre de la categoría</th>
                        <th>Activo</th>
                        <th>Prefijo de la categoría</th>
                        <th>Editar</th>
                        <th>Eliminar</th>
                      </tr>
                    </tfoot>
