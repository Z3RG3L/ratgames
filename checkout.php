...
<section class="py-5">
    <div class="container px-4 px-lg-5 my-5">
        <div class="row gx-4 gx-lg-5 align-items-center">
            ...
            $sql = " select * from cliente inner join usuario where md5(usuario.nom_usu) = '" . $_SESSION["nom_usu"] . "'";
            ...
            if ($cuentaCarrito > 0) {
                foreach ($carrito as $x => $x_value) {
                    ...
                    $sql = "select prec_pro from producto inner join inventario on producto.id_pro = inventario.id_inv where producto.id_pro = " . $x;

                    $result = $conn->query($sql);

                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            $TotalCompra += ($row["prec_pro"] * $x_value);
                        }
                    }
                }
            }
            ...
            <div class='product_wrapper'>
                ...
                <form method='post' action='https://www.sandbox.paypal.com/cgi-bin/webscr'>
                    ...
                    <input type='hidden' name='business' value='lars-x2@live.com.mx'>
                    ...
                    <input type='hidden' name='return' value='http://localhost/uteQ_T203/ratgames/confirmado.php'>
                    <input type='hidden' name='cancel_return' value='http://localhost/uteQ_T203/ratgames/cancelado.php'>
                    <input type='hidden' name='notify_url' value='http://localhost/uteQ_T203/ratgames/cancelado.php'>
